...
// In the upper right corner, click the blue box that says DEPLOY.
// Then, select NEW DEPLOYMENT. Leave the default options and select DEPLOY.
// If you must select a type, click the gear and select WEB APP.
// Copy the URL for the Web App and paste it below between the parentheses in place of the placeholder.
var SCRIPT_URL = 'PLACEHOLDER_URL'
